...
if __name__ == '__main__':
    ...
    colors = {3:'r',
              ...
              9:'y',
              0:'grey'}
    for i, csv in enumerate(glob.glob(os.path.join(dir_of_this_script, "whole_experiment_only_success", "*", "*csv"))):
        print i
        print csv
        print 
    ...
    f.savefig(os.path.join(output_dir, "multi_whole_success_exps_norms.png"),format='png', dpi=300)
    f.savefig(os.path.join(output_dir, "multi_whole_success_exps_norms.eps"),format='eps', dpi=300)    
    plt.show()
