...
if __name__ == '__main__':
    ...
    #       
        ...
        for i, data in enumerate(signals):
            ...
            # if i > 300: break
        np.save("success_unsuccess/100hz_unsuccess_skill_"+ str(skill)+"_26dim_values_trial_nums_clean.npy", values_tags_trial_nums_clean)
        np.save("success_unsuccess/100hz_unsuccess_skill_"+ str(skill)+"_26dim_values_trial_nums_thinner.npy", values_tags_trial_nums_thinnner)
