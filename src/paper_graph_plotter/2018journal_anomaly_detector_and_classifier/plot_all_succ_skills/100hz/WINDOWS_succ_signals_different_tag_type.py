...
if __name__ == '__main__':
    ...
    for skill in (3,4,5,7,8,9,1000,1001,1002,1003):
        data_path = '/home/birl-spai-ubuntu14/baxter_ws/src/SPAI/smach_based_introspection_framework/jim_folder_have_tag_range_100hz/anomaly_detection_feature_selection_folder/No.0 filtering scheme/successful_skills/skill ' + str(skill)
    ...
    #        ax.set_title("Multimodal signals of norminal execution #%s" %(i+1))
        ...
        label_occu = np.array(label_occu)
            ...
            # if i > 300: break
        np.save("data/windows/100hz_success_skill_"+ str(skill)+"_27dim_windows.npy", values_tags_trial_nums_clean)
        np.save("data/windows/100hz_success_skill_"+ str(skill)+"_27dim_windows_label_occu.npy", label_occu)
