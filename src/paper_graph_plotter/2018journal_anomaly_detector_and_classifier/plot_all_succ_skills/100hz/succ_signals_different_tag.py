...
if __name__ == '__main__':
    ...
    #       
        ...
        np.save("success_unsuccess/success_skill_"+ str(skill)+"_26dim_values_trial_nums_clean.npy", values_tags_trial_nums_clean)
        np.save("success_unsuccess/success_skill_"+ str(skill)+"_26dim_values_trial_nums_thinner.npy", values_tags_trial_nums_thinnner)
