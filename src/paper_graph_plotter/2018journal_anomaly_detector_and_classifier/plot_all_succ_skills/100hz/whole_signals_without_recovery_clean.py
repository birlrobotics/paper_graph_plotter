...
if __name__ == '__main__':
    ...
    data_path = "/home/birl-spai-ubuntu14/baxter_ws/src/SPAI/smach_based_introspection_framework/jim_folder_have_tag_range_100hz/anomaly_detection_feature_selection_folder/No.0 filtering scheme/whole_experiment/"
    experience_tuple = []
        ...
        for tag, start, end in tag_stime:
            ...
            if int(tag) != 0:
                ...
                #     continue
                    ...
                    last_start =start
                    Times = np.append(Times,last_end)
    ...
    np.save("data/100hz_windows_no_recovery_skills_29dim_recovery_values_tags_trial_nums_clean.npy", values_tags_trial_nums_clean)
