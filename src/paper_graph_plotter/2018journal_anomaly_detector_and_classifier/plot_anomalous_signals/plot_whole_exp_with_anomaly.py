...
if __name__ == '__main__':
    ...
    for i, csv in enumerate(glob.glob(os.path.join(dir_of_this_script, "whole_exp_with_one_anomaly", "*", "*csv"))):
        ...
        ax.axvspan(anomaly_time - 3, anomaly_time + 3, ymin=0.1, ymax=0.9, facecolor='green', alpha=0.4)                
        ax.axvspan(anomaly_time - 4, anomaly_time + 4, ymin=0.2, ymax=0.8, facecolor='blue', alpha=0.2)        
